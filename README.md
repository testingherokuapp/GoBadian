...
## IMPORTANT
For first time set up remove ALL text already there and replace it with https://sideways-numerous-twister.glitch.me/. If its blocked then hit the back arrow untill its unblocked (bug) then type in google.com into the search bar and hit enter. Now it will work, you can refresh the page and hit enter without removing the text now and it will work properly. Video of tutorial --->
